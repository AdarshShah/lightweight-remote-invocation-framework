...
public class CalculatePi implements Task, Serializable {
	 ...
	 */
	 public CalculatePi() {
		 ...
		 tid.setContentText("Enter Decimal Digits:");
		 tid.setHeaderText("Calculate Pi");
		 tid.showAndWait();
		 this.digits = Integer.parseInt(tid.getResult());
		 tid.close();
	 }
	 ...
	 * The value 2 is computed using the power series expansion for the arc tangent:
	 *
